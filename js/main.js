...
$(document).ready(function () {
    ...
    $('.add-items').submit(function (event) {
        ...
        if (!item) {
            ...
            $('#list-items').append("<li><input class='checkbox' type='checkbox'/>" + item + "<a class='remove'>Delete</a><a class='edit-task'>Edit</a><hr></li>");
    ...
    function editTask(){           //+
        $(".edit-task").click(function () {
            var valueEditTask = $(this).siblings('item').text();
            $('#myModal').modal("show");
        });
    }                              //+
